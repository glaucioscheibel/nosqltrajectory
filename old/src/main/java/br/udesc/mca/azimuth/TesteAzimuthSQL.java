...
public class TesteAzimuthSQL {
    ...
    public static void main(String[] args) {
        ...
        PersistenceDAO daoRelac = PersistenceDAO.getInstance(PersistenceModel.RELATIONAL);
        Trajectory trajectory = daoRelac.findById(1);
        List<TrajectoryVersion> listaVersao = (List<TrajectoryVersion>) trajectory.getVersions();
