package br.udesc.mca.segmenter;
...
public class SegmenterByPoints {
    public static List<TrajectorySegment> segmenter(TrajectorySegment segment, int points) {
    ...
    public static TrajectorySegment desegment(List<TrajectorySegment> segments) {
