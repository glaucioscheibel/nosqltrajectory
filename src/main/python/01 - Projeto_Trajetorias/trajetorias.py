...
def main():
    ...
    trajetorias_similares_tempo = determina_trajetorias_similares(pares_com_percentual,97)
    print(trajetorias_similares_tempo)
    ...
    trajetorias_similares_comprimento = determina_trajetorias_similares(percentual_similaridade_comprimento,99)
