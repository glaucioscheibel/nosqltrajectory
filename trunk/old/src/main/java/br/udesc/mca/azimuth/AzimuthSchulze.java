...
public class AzimuthSchulze {
	...
	public static void main(String[] args) {
		...
		azimute1 = ((Double) Azimuth.azimuth(t1p1Schulze.getLatitude(),
				t1p1Schulze.getLongitude(), t1p2Schulze.getLatitude(),
				t1p2Schulze.getLongitude())).toString();
		azimute1 = azimute1
				+ " "
				+ ((Double) Azimuth.azimuth(t1p2Schulze.getLatitude(),
						t1p2Schulze.getLongitude(), t1p3Schulze.getLatitude(),
						t1p3Schulze.getLongitude())).toString();

		azimute2 = ((Double) Azimuth.azimuth(t2p1Schulze.getLatitude(),
				t2p1Schulze.getLongitude(), t2p2Schulze.getLatitude(),
				t2p2Schulze.getLongitude())).toString();
		
		azimute2 = azimute2
				+ " "
				+ ((Double) Azimuth.azimuth(t2p2Schulze.getLatitude(),
						t2p2Schulze.getLongitude(), t2p3Schulze.getLatitude(),
						t2p3Schulze.getLongitude())).toString();
		 ...
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'20.59\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'22.88\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'21.41\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'22.06\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'21.81\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'21.07\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'21.76\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'20.21\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'20.96\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'20.06\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'19.61\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'21.44\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'18.11\"O"));
		 * 
		 * System.out.println("================================================="
		 * ); System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'24.00\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'14.17\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'24.51\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'13.05\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'25.33\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'12.56\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'26.32\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'12.71\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'26.92\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'13.34\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'26.91\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'14.87\"O")); System.out.println();
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("26°15'25.63\"S"));
		 * System.out.println(PointConverter
		 * .converterToDecimalDegree("48°54'15.93\"O")); System.out.println();
		 */
	}
}
