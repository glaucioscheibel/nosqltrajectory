...
public class TesteAzimuth {
	...
	public static void main(String[] args) {
		...
		System.out.println(PointConverter
				.converterDecimalDegress("48°54'14.17\"O"));
		System.out.println();
		System.out.println(PointConverter
				.converterDecimalDegress("26°15'24.51\"S"));
		System.out.println(PointConverter
				.converterDecimalDegress("48°54'13.05\"O"));
		System.out.println();
		System.out.println(PointConverter
				.converterDecimalDegress("26°15'25.33\"S"));
		System.out.println(PointConverter
				.converterDecimalDegress("48°54'12.56\"O"));
		System.out.println();
		System.out.println(PointConverter
				.converterDecimalDegress("26°15'26.32\"S"));
		System.out.println(PointConverter
				.converterDecimalDegress("48°54'12.71\"O"));
		System.out.println();
		System.out.println(PointConverter
				.converterDecimalDegress("26°15'26.92\"S"));
		System.out.println(PointConverter
				.converterDecimalDegress("48°54'13.34\"O"));
		System.out.println();
		System.out.println(PointConverter
				.converterDecimalDegress("26°15'26.91\"S"));
		System.out.println(PointConverter
				.converterDecimalDegress("48°54'14.87\"O"));
		System.out.println();
		System.out.println(PointConverter
				.converterDecimalDegress("26°15'25.63\"S"));
		System.out.println(PointConverter
				.converterDecimalDegress("48°54'15.93\"O"));
		System.out.println();
